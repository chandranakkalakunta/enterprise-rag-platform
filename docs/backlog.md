...
Last updated: 2026-07-16 (Phase 0 Beta — comprehensive documentation)
...
| BL-FND-02 | ADR-0001 architecture + ADR-0002 tech stack | Done | Phase 0 | |
| BL-FND-03 | requirements.md + backlog + protocol | Done | Phase 0 | Expanded in 0 Beta |
| BL-FND-04 | Terraform skeleton (`var.gcp_project_id`) | Done | Phase 0 | Skeleton only; no apply yet |
| BL-FND-09 | Remove hard-coded GCP project IDs from docs/TF | Done | Phase 0.1 | |
| BL-FND-10 | Detailed requirements v2 + UI specs + arch overview | Done | Phase 0 Beta | This change set |
...
| ID | Item | Status | Phase / PR | Notes |
|----|------|--------|------------|-------|
| BL-SEC-01 | Google OAuth login (US-AUTH-01 / US-EU-01) | Todo | Phase 1 | |
| BL-SEC-02 | Role model: user / content_admin / operator | Todo | Phase 1–2 | Optional security_auditor |
...
| BL-SEC-06 | Admin action audit log (US-SC-04) | Todo | Phase 2 | |

## Ingestion & Versioning

| ID | Item | Status | Phase / PR | Notes |
|----|------|--------|------------|-------|
| BL-ING-01 | Document upload API + GCS storage | Todo | Phase 2 | US-CA-01 |
| BL-ING-02 | Parse PDF/DOCX/MD/HTML | Todo | Phase 2 | |
| BL-ING-03 | Chunking strategy + metadata | Todo | Phase 2 | May need ADR |
| BL-ING-04 | Version publish / retire workflow | Todo | Phase 2 | ADR-0003 |
| BL-ING-05 | Embed + index pipeline (async) | Todo | Phase 2–3 | |
| BL-ING-06 | Atomic index alias swap on publish | Todo | Phase 3 | ADR-0003; was deferred |
| BL-ING-07 | Ingest job visibility UI/API | Todo | Phase 2 | US-CA-04 |
...
| BL-RAG-04 | Insufficient-evidence refusal | Todo | Phase 3 | ADR-0004 L3 |
| BL-RAG-05 | ACL-aware retrieval | Todo | Phase 3 | |
| BL-RAG-06 | Multi-turn conversation memory | Deferred | Phase 4 | US-EU-04 / US-QA-04 |
| BL-RAG-07 | Collection / filter scope | Deferred | Phase 4 | US-EU-05 / US-QA-05 |
| BL-RAG-08 | Optional token streaming to client | Deferred | Phase 3+ | Open decision |

## Guardrails

| ID | Item | Status | Phase / PR | Notes |
|----|------|--------|------------|-------|
| BL-GRD-01 | Prompt-injection defenses (L1/L4) | Todo | Phase 3–4 | ADR-0004 |
| BL-GRD-02 | Output grounding / citation checks (L5) | Todo | Phase 3–4 | |
...
| ID | Item | Status | Phase / PR | Notes |
|----|------|--------|------------|-------|
| BL-VOICE-01 | STT integration | Deferred | Phase 5 | ui-specs §6 |
| BL-VOICE-02 | TTS integration | Deferred | Phase 5 | |
| BL-PWA-01 | Installable PWA shell | Deferred | Phase 5 | ui-specs §7 |
...
| ID | Item | Status | Phase / PR | Notes |
|----|------|--------|------------|-------|
| BL-ANL-01 | BigQuery query metadata pipeline (no raw PII) | Todo | Phase 6 | overview §7 |
...
| BL-FE-02 | shadcn/ui + app shell per ui-specs | Todo | Phase 1–2 | NFR-MNT-05 |
...
| BL-FE-07 | A11y pass on primary flows | Todo | Phase 3+ | NFR-A11Y-* |

## Open decisions (need ADR soon)

| ID | Decision | Status | Target ADR |
|----|----------|--------|------------|
| BL-DEC-01 | Firestore vs Cloud SQL for metadata | Todo | ADR-0005 |
| BL-DEC-02 | Exact embedding model + dimensions | Todo | ADR-0006 |
| BL-DEC-03 | Vector Search index topology / alternative | Todo | ADR-0006 |
| BL-DEC-04 | STT/TTS provider selection | Deferred | Phase 5 ADR |
| BL-DEC-05 | Async worker: Cloud Tasks vs Cloud Run jobs | Todo | Phase 2 ADR |

---

## Recently completed

- **2026-07-16** — Phase 0 Beta: requirements v2 (persona stories + NFRs), `ui-specs.md`, architecture overview, ADR-0003/0004, backlog/traceability updates.
